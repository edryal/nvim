-- Poorly tested, might not even work properly
return {
  "dsych/blanket.nvim",
  opts = {
  ...
  init = function()
    ...
    vim.api.nvim_create_autocmd("FileType", {
      pattern = { "java" },
      callback = function()
        vim.keymap.set("n", "<leader>jjr", toggle_coverage_report, { buffer = 0, desc = "Toggle Coverage Report" })
        vim.keymap.set("n", "<leader>jjb", open_jacoco_report, { buffer = 0, desc = "Open In Browser" })
      end,
    })
  end,
}
